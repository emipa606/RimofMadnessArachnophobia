...
namespace Arachnophobia
{
    ...
    static class HarmonyPatches
    {
        ...
        // RimWorld.Faction
        public static bool Notify_MemberDied_Prefix(Faction __instance, Pawn member, DamageInfo? dinfo, bool wasWorldPawn)
        {
            return dinfo == null || !(dinfo.Value.Instigator is PawnWebSpinner);
        }
